...
public class Post {
    ...
    @Test(description = "Add policy context using policy with no name")
	...
	// BEGIN: Need to delete policy context incorrectly created
	String urlDelete = swagger_url + "/policyContext/default";
	...
	// END: Need to delete policy context incorrectly created
	...
	System.out.println("post09: " + response.getStatusLine());
	...
	System.out.println("post10: " + response.getStatusLine());
